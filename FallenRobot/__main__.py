...
PHOTO = [
    "http://master.koyeb.app/view/O8Eu5i1e",
    "http://master.koyeb.app/view/GKpvGj89",
    "http://master.koyeb.app/view/e8AEpWll",
    "http://master.koyeb.app/view/1eB9fqWw",
    "http://master.koyeb.app/view/HaxXOSDC",
    "http://master.koyeb.app/view/SMHSyADT",
    "http://master.koyeb.app/view/HGvUtTab",
    "http://master.koyeb.app/view/zkZnFpJP",
]
PHOT = random.choice(PHOTO)
PM_START_TEXT = (
    f"```𝖧𝖾𝗅𝗅𝗈 {{}}, Qt ```\n"
    "➻ 𝖬𝗒𝗌𝖾𝗅𝖿 *Marin T~T* 𝖳𝗁𝖾 𝖬𝗈𝗌𝗍 𝖯𝗈𝗐𝖾𝗋𝖿𝗎𝗅 & cool 𝖳𝖾𝗅𝖾𝗀𝗋𝖺𝗆 𝖦𝗋𝗈𝗎𝗉 Managing 𝖡𝗈𝗍 𝖶𝗂𝗍𝗁 𝖲𝗈𝗆𝖾 𝖠𝗐𝖾𝗌𝗈𝗆𝖾 𝖠𝗇𝖽 𝖴𝗌𝖾𝖿𝗎𝗅 𝖥𝖾𝖺𝗍𝗎𝗋𝖾𝗌.\n"
    "──────────────────────\n"
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="🥀 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 🥀", url="https://t.me/+4zQayEglcVAxYmFl"
        ),
    ],
]
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAxkBAAEPw9FpFbe977Or7e-DUOGa4t8ZTIr54gACFx0AAvqGWFSlkj8zKF23fzYE"
            )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="🪩 Cʜᴀɴɴᴇʟ", callback_data="Support"
                        ),
                        InlineKeyboardButton(
                            text="Uᴩᴅᴀᴛᴇꜱ 🪩", url="t.me/Emitingstars_botz"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            text="📇 AʀᴄʜɪᴠE 📇", url="https://t.me/Emitingstars_botz"
                        ),
                    ],
                    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Sᴜᴩᴩᴏʀt", url="https://t.me/Emitingstars_botz"
                        ),
                        InlineKeyboardButton(
                            text="Uᴩᴅᴀᴛᴇs", url="t.me/Emitingstars_botz"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="LᴇᴇᴄH", url="t.me/LioNleeCh"),
                    ],
                    [
...
def _run_flask():
    """Run a minimal Flask health-check server so Render sees an open HTTP port."""
...
if __name__ == "__main__":
    ...
    # Start Flask in a background daemon thread so Render detects an open port
